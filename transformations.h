 ...
 *
 * Creates copy of image with changed brightness.
 *
 * @arg image the image
 * @arg factor the factor by which the brightness is changed, factor > 1 image is brighter, factor < 1 image is darker
 * @return the copy of image with changed brightness or null, if there is no image (NULL given)
 */
