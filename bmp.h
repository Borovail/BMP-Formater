...
/**
 * Creates a new BMP image with the same header as the original image
 *
 * Function creates a new BMP image with the same header as the original image.
 * The new image has the same dimensions as the original image, but the data
 * are not copied.
 *
 * @param image the original BMP image
 * @return the new BMP image with the same header as the original image
 */
